DROP DATABASE IF EXISTS jlstudios;
CREATE DATABASE jlstudios DEFAULT CHARSET UTF8;
USE jlstudios;
...
INSERT INTO admin (username,userpwd,nickname,phone,email) value ('admin',MD5('123456'),'Administrator','18835204985','846790636@qq.com')
